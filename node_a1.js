...
//fs.writeFileSync('space_project/log.txt', '\n ISRO has started working on Gaganyaan.');
...
// 3.Now, replace the line in the log.txt file with "ISRO has started working on Gaganyaan."
// fs.writeFile('space_project/log.txt', '\n ISRO has started working on Gaganyaan.', (err) => {
//     if (err) throw err;
